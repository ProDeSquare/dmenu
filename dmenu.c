...
/* ======= */
/* enum { SchemeNorm, SchemeSel, SchemeHp, SchemeOut, SchemeLast }; /1* color schemes *1/ */
/* >>>>>>> */
...
usage(void)
{
	fputs("usage: dmenu [-bfiv] [-l lines] [-p prompt] [-fn font] [-m monitor]\n"
	      ...
	      "             [-nhb color] [-nhf color] [-hb color] [-hf color] [-hp items] [-shb color] [-shf color] [-w windowid]\n", stderr);
/* ======= */
